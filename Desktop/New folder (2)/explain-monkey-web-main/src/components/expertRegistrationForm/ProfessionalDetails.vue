<template>
  <div>
    ...
    <p class="padding-left-10">Add another Education background </p>
      ...
      <button class="green bg-white padding-10 margin-right-10 border-0 border-radius-6 "  type="button" @click="handleNavigation('personal-information')">
        Previous Step
      </button>
      <button class="white bg-green padding-10 margin-right-10 border-0 border-radius-6 " type="button" @click="handleNavigation('references')">
        Next Step
      </button>
      </div>
    </form>
