    ...
    <div class="content-container">
      <div class="header" ref="closeCategories">
        <nav class="navbar white">
          <router-link to="/"
            class="navbar-brand cursor-pointer font-size-17 font-size-md-12"
          >
        ...
        >
          <div
            class="container-250 bg-white black border-radius-10 padding-10 border-1 border-color-grey"
            v-if="cuurentScreenWidth < '768'"
          >
            <HeaderContents
              @handleCategories="handleCategories"
              @showLogin="handleShowLogin"
...
import CategoriesContents from "../header/CategoriesContents";
...
export default {
  ...
  computed: {
    ...mapState({
      cuurentScreenWidth: (state) => state.utilities.currentScreenWidth,
    }),
  },
  ...
  methods: {
    ...
    documentClick(e) {
      let categories_el = this.$refs.closeCategories;
      let target = e.target;
