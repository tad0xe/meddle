<template>
  ...
  <div class="d-flex padding-top-20 ">
    ...
    <p class="padding-left-10">Add Refree</p>
      ...
      <button class="green bg-white border-color-green outline-0 padding-10 margin-right-10 border-0 border-radius-6" type="button" @click="handleNavigation('professional-details')">
      <    Previous Step
      </button>
      <button class="white bg-green padding-10 margin-right-10 border-0 border-radius-6" type="button" @click="handleNavigation('activation')">
        Next Step    >
      </button>
      </div>
    </form>
