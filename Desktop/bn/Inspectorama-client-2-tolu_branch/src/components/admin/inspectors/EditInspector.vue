  ...
  <div>
    <div class="container">
      <div class="left-menu-container">
        ...
        <div
          class="category-tab"
          :class="{active: isAccountInformationForEditVisible}"
      ...
      <div class="main-container">
        ...
        <div class="category-view">
          <AccountInformationForEdit
            v-show="isAccountInformationForEditVisible"
...
import AccountInformationForEdit from "./generalEditingTemplates/AccountInformationForEdit.vue";
...
export default {
  ...
  data() {
    return {
      isAccountInformationForEditVisible: true,
  ...
  methods: {
    hideAll() {
      this.isAccountInformationForEditVisible = false;
    ...
    onClickAccountInformationForNewTab() {
      this.hideAll();
      this.isAccountInformationForEditVisible = true;
    },
