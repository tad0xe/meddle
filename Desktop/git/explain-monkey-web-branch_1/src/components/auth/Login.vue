  ...
  <div >
    <form class="modal" @submit="handleSubmit" >
      <div class="d-flex align-items-center">
        <h1 class="flex-grow-1 font-size-24">Login</h1>
      ...
      <br />
      <div class="float-end grey" @click="handleShowForgotPassword">
        Forgot Password?
      </div>
      <br />
      <div
      ...
      >
        <button
          class="btn bg-black white font-size-16 padding-8 max-width-250 border-radius-10"
          type="submit"
        >
          Log In
        </button>
      ...
      <div class="d-flex padding-top-10">
        <span class="grey">Don't have an account?</span>&nbsp;
        <b @click="handleShowUserSignUp">Sign Up</b>
      </div>
    </form>
  </div>
</template>
...
export default {
  ...
  methods: {
    ...
    handleSubmit(){
      this.$router.push("/dashboard/user/home")
    }
  },
};
</script>
