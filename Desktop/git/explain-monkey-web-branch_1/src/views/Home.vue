<template>
  <div>
    <div class="container">
      <div class="home-top-background-image white">
        <div class="home-top-background-image-content padding-bottom-10">
          <div class="row content-container">
            ...
            >
              <div class="max-width-360 stretch-full-md">
                <h1
      ...
      >
        <div class="max-width-550 text-center">
      ...
      <div class="row">
        ...
        >
          <div>
            ...
            <div
              class="max-width-550 container-radius-20 bg-light-grey padding-10 padding-md-30"
            >
