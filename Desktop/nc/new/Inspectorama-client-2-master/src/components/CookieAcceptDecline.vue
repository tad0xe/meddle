    ...
    >
      <div :class="'cookie__' + type + '__wrap'">
        ...
        <div :class="'cookie__' + type + '__content'">
          <slot name="message">
            {{$t("cookieAcceptDecline.text")}}
            <a
              href="https://www.inspectorama.com/cookie-policy"
              target="_blank"
            >{{$t("cookieAcceptDecline.learnMore")}}</a>
          </slot>
        </div>
        ...
        <div :class="'cookie__' + type + '__buttons'">
          ...
          >
            <slot name="acceptContent">{{$t("buttons.gotIt")}}</slot>
          </button>
        </div>
      </div>
    </div>
  ...
  methods: {
    ...
    setCookieStatus(type) {
      if (this.supportsLocalStorage) {
        ...
        if (type === "postpone") {
          localStorage.setItem(`vue-cookie-accept-decline`, "postpone");
        }
      } else {
        if (type === "accept") {
        ...
        if (type === "postpone") {
          tinyCookie.set(`vue-cookie-accept-decline`, "postpone");
        }
      }
    },
    getCookieStatus() {
