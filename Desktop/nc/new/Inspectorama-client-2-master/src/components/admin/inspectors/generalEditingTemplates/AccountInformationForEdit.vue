...
export default {
  ...
  methods: {
    onSubmit(action) {
      ...
      axios
        .patch(`/customer_users/edit/${inspectorId}`, inspectorInfoData)
        .then(res => {
          console.log(res);
          if (action == "next") {
  ...
  created() {
    ...
    axios
      ...
      .then(res => {
        this.inspectorInfo.firstName = res.data.firstName;
        this.inspectorInfo.lastName = res.data.lastName;
        this.inspectorInfo.email = res.data.email;
        this.inspectorInfo.password = res.data.password;
        this.inspectorInfo.pro = res.data.pro;
        this.inspectorInfo.contactInfo = res.data.contactInfo;
      })
      .catch(error => {
        console.log(error);
      });
